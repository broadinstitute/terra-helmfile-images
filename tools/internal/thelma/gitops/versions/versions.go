...
type Versions interface {
	...
	LoadSnapshot(releaseType release.ReleaseType, versionSet Set) (Snapshot, error)
}
...
func (v *versions) LoadSnapshot(releaseType release.ReleaseType, versionSet Set) (Snapshot, error) {
...
func snapshotPath(thelmaHome string, releaseType release.ReleaseType, set Set) string {
